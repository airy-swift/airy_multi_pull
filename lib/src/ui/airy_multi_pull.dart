...
/// [AiryMultiPull] far enough to demonstrate that they want the app to
/// refresh. The returned [Future] must complete when the refresh operation is
/// finished.
///
/// Used by [AiryMultiPull.onRefresh].
...
/// Used to configure how [AiryMultiPull] can be triggered.
...
///
/// The trigger mode is configured by [AiryMultiPull.triggerMode].
///
/// {@tool dartpad}
/// This example shows how [AiryMultiPull] can be triggered in different ways.
///
/// ** See code in examples/api/lib/material/refresh_indicator/refresh_indicator.0.dart **
/// {@end-tool}
///
/// {@tool dartpad}
/// This example shows how to trigger [AiryMultiPull] in a nested scroll view using
...
///
/// {@tool dartpad}
/// This example shows how to use [AiryMultiPull] without the spinner.
///
...
///
/// The [AiryMultiPull] will appear if its scrollable descendant can be
/// overscrolled, i.e. if the scrollable's content is bigger than its viewport.
/// To ensure that the [AiryMultiPull] will always appear, even if the
...
/// ```
///
/// A [AiryMultiPull] can only be used with a vertical scroll view.
///
/// See also:
///
///  * <https://material.io/design/platform-guidance/android-swipe-to-refresh.html>
///  * [AiryMultiPullState], can be used to programmatically show the refresh indicator.
///  * [RefreshProgressIndicator], widget used by [AiryMultiPull] to show
...
class AiryMultiPull extends StatefulWidget {
  ...
  /// Creates an adaptive [AiryMultiPull] based on whether the target
  ...
  /// Called to get the current status of the [AiryMultiPull] to update the UI as needed.
  ...
  /// Defines how this [AiryMultiPull] can be triggered when users overscroll.
  ///
  /// The [AiryMultiPull] can be pulled out in two cases,
  ...
  /// Defines the elevation of the underlying [AiryMultiPull].
  ///
  /// Defaults to 2.0.
...
/// Contains the state for a [AiryMultiPull]. This class can be used to
...
class AiryMultiPullState extends State<AiryMultiPull> with TickerProviderStateMixin<AiryMultiPull> {
  ...
  ///
  /// Creating the [AiryMultiPull] with a [GlobalKey<RefreshIndicatorState>]
  /// makes it possible to refer to the [AiryMultiPullState].
  ///
  /// The future returned from this method completes when the
  /// [AiryMultiPull.onRefresh] callback's future completes.
  ///
